...
export async function POST(request) {
  ...
  try {
    ...
    if (isExist == "false") {
      return new Response(JSON.stringify({ data: 'errorMail', message: "Error email does not exist.", error: ' Email does not exist' }));
    }
    else {
                  ...
                  <body>
                    <div class="container">
                      ...
                      <div class="button" style="text-decoration: none; color: white; ">
                        <a href="${process.env.NEXT_PUBLIC_URL}/client/reset-password?mail=${userMail}" style="text-decoration: none; color: white;">
                        Clique ici
                        </a>
                      </div>
                    </div>
